...
import { product_two } from "../../data/data";
...
const ProductDetailsScreen2 = () => {
  const stars = Array.from({ length: 5 }, (_, index) => (
    <span
      key={index}
      className={`text-yellow ${
        index < Math.floor(product_two.rating)
          ? "bi bi-star-fill"
          : index + 0.5 === product_two.rating
          ? "bi bi-star-half"
          : "bi bi-star"
      }`}
    ></span>
    ...
    <DetailsScreenWrapper>
      <Container>
        ...
        <DetailsContent className="grid">
          <ProductPreview previewImages={product_two.previewImages} />
          <ProductDetailsWrapper>
            <h2 className="prod-title">{product_two.title}</h2>
            <ProductSizeWrapper>
              ...
              <div className="prod-size-list flex items-center">
                {product_two.sizes.map((size, index) => (
            ...
            <ProductColorWrapper>
              ...
              <div className="prod-colors-list flex items-center">
                {product_two?.colors?.map((color, index) => (
            ...
            <div className="btn-and-price flex items-center flex-wrap">
              ...
              <span className="prod-price text-xl font-bold text-outerspace">
                {currencyFormat(product_two.price)}
              </span>
            </div>
            <ProductServices />
          </ProductDetailsWrapper>
