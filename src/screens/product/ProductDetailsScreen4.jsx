...
const ProductDetailsScreen4 = () => {
  const stars = Array.from({ length: 5 }, (_, index) => (
    <span
      key={index}
      className={`text-yellow ${
        index < Math.floor(product_four.rating)
          ? "bi bi-star-fill"
          : index + 0.5 === product_four.rating
          ? "bi bi-star-half"
          : "bi bi-star"
      }`}
    ></span>
    ...
    <DetailsScreenWrapper>
      <Container>
        ...
        <DetailsContent className="grid">
          <ProductPreview previewImages={product_four.previewImages} />
          <ProductDetailsWrapper>
            <h2 className="prod-title">{product_four.title}</h2>
            <ProductSizeWrapper>
              ...
              <div className="prod-size-list flex items-center">
                {product_four.sizes.map((size, index) => (
            ...
            <ProductColorWrapper>
              ...
              <div className="prod-colors-list flex items-center">
                {product_four?.colors?.map((color, index) => (
